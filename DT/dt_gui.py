"""
dt_gui.py  —  Streamlit GUI for Decision Tree AI Text Detector
Run: streamlit run dt_gui.py

Requires: streamlit, joblib, numpy, pandas, nltk, matplotlib
Model:    dt_model.pkl  (generated by train_decision_tree.py)
"""
...
TREE_LEAF = -1          # sklearn internal constant — leaf node marker
TREE_UNDEFINED = -2    # sklearn internal constant — no feature at leaf
